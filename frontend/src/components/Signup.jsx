...
//     e.preventDefault();
//     try {
//       const res = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/api/v1/user/register`, user, {
//         headers: {
...
//   <div className="w-full max-w-md p-6 bg-white bg-opacity-90 rounded-lg shadow-xl" style={{ maxHeight: '550px' }}> {/* Covers 50% of screen height */}
